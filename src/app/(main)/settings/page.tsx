              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-muted">
                      <div className="w-full h-8 bg-gradient-to-r from-white to-gray-900 border rounded mb-2"></div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4">
                {[
                  { name: "Gmail", description: "Sync your Gmail contacts and send emails", connected: true },
                  { name: "Slack", description: "Get notifications in your Slack workspace", connected: false },
                  { name: "HubSpot", description: "Import leads from HubSpot CRM", connected: true },
                  { name: "Salesforce", description: "Sync data with Salesforce", connected: false },
